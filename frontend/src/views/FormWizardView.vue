    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-8">
      ...
      <div v-if="resubmitReason" class="bg-red-50 border-l-4 border-red-400 rounded-md p-4 mb-4">
        <div class="flex">
          ...
          <div class="ml-3">
            <h3 class="text-sm font-medium text-red-800">Resubmission Required</h3>
            <p class="mt-1 text-sm text-red-700">This form was rejected by your manager: <strong>{{ resubmitReason }}</strong>. Please make the necessary corrections and resubmit.</p>
          </div>
        </div>
      </div>
...
onMounted(async () => {
  ...
  // Check for step query parameter (e.g., from resubmit link)
  if (route.query.step) {
